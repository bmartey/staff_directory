...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = "<a value='{$row['NAME']}'>{$row['NAME']}</a>";
	$nestedData[] = "<a value='{$row['DIVISION']}'>{$row['DIVISION']}</a>";
	$nestedData[] = "<a value='{$row['LOCATION']}'>{$row['LOCATION']}</a>";
	...
	$nestedData[] = "<a href='#' id='{$row['ID']}' class='button' name='deactivate' value={$row['ID']} onclick='disable({$row['ID']})' type='submit' id='deactivate' >Deactivate Employee</a>";
